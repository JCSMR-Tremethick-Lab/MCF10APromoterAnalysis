...
emtGenes <- resultsCompressed[["MCF10A"]]$sleuth_results.gene[["conditionMCF10A_TGFb"]][which(resultsCompressed[["MCF10A"]]$sleuth_results.gene[["conditionMCF10A_TGFb"]]$target_id %in% hsap.qPCRGenesTab$ensembl_gene_id),]
...
emtGenes.shZ <- resultsCompressed[["MCF10A"]]$sleuth_results.gene[["conditionMCF10A_shZ"]][which(resultsCompressed[["MCF10A"]]$sleuth_results.gene[["conditionMCF10A_shZ"]]$target_id %in% hsap.qPCRGenesTab$ensembl_gene_id),]
